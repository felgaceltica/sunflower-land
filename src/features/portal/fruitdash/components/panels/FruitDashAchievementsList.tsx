...
export const FruitDashAchievementsList: React.FC<Props> = ({ onBack }) => {
  ...
  const inProgressAchievementNames = (
    Object.keys(AVAILABLE_ACHIEVEMENTS) as FruitDashAchievementsName[]
                ...
                return (
                  <InnerPanel key={index}>
                    ...
                    <Label type="success" className="text-xs">
                      {t("fruit-dash.achievementUnlockedAt", {
