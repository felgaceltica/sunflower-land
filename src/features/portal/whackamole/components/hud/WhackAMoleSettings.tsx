...
import { useIsDarkMode } from "../../util/useIsDarkMode";
...
export const WhackAMoleSettings: React.FC = () => {
  ...
  const buttons = [gearButton, darkModeButton, musicButton, audioButton];
