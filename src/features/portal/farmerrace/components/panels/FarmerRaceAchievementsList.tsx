...
export const FarmerRaceAchievementsList: React.FC<Props> = ({ onBack }) => {
  ...
  const inProgressAchievementNames = (
    Object.keys(AVAILABLE_ACHIEVEMENTS) as FarmerRaceAchievementsName[]
                ...
                return (
                  <InnerPanel key={index}>
                    ...
                    <Label type="success" className="text-xs">
                      {t("farmer-race.achievementUnlockedAt", {
